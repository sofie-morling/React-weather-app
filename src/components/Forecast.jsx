...
export const Forecast = () => {
    const api = {
        ...
        useEffect(() => {
          fetch(`https://hendrik-cors-proxy.herokuapp.com/api.openweathermap.org/data/2.5/forecast?lat=${position.latitude}&lon=${position.longitude}&units=${unit}&appid=${api.key}`)
            .then(res => res.json())
            .then(result => {
              setWeather(result)
